...
TEST_IMAGES = "test_images"                # folder of images to benchmark
OUTPUT_DIR  = "results/edge_study"         # where result CSVs go
GPU_CSV     = "results/gpu/inference_summary.csv"  # from inference_gpu.py (for PyTorch baseline)
